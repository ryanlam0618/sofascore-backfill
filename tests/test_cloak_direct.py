#!/usr/bin/env python3
"""
Test: CloakBrowser direct connection (no proxy) vs SofaScore
Reproduce the previous successful method from 2026-08-12 report.
"""
...
# Test event: Premier League 24/25 match
EVENT_ID = 12436870
...
print("=" * 60)
print("CloakBrowser Direct Connection Test (NO PROXY)")
print("=" * 60)

# Launch WITHOUT proxy
print("\n[1] Launching CloakBrowser (no proxy)...")
browser = launch(
    headless=True,
    humanize=True,
    # NO proxy!
...
print("    ✅ Browser launched (direct connection)")
