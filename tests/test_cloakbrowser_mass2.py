#!/usr/bin/env python3
"""
Mass CloakBrowser test — Part 2: From K League 1 onwards.
(Continues from where Part 1 left off at J1 League 2023.)
"""
...
# Only test competitions from K League 1 onwards (skip ones already tested)
skip_comps = {"Premier League","La Liga","Serie A","Bundesliga","Ligue 1","J1 League"}

# For J1 League, only test 2023, 2024, 2025 (already did 2015-2022)
j1_partial = True
...
print("=== CloakBrowser Mass Test Part 2 ===")
    ...
    for year_label, season_id in sorted_seasons:
        ...
        if eid is None:
            ...
            detail_results.append({
                ...
                "event_id": None, "endpoints": {}, "note": "no event found"
            })
            # Save even on no-event
            with open("data/cloak_test_mass_results_part2.json", "w") as f:
